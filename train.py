...
MODEL_DIR="/amax/2020/qyl/SAVC/checkpoint/classroom/savc/ft_cos-avg_cos-data_init-start_0/Cosine-Epo_200-Lr_0.1000-T_16.00-fantasy_rotation2-alpha_0.20-beta_0.80/session0_max_acc.pth"
DATA_DIR = '/amax/2020/qyl/CVPR22-Fact-main/data'
PROJECT='savc'
...
def get_command_line_parser():
    ...
    parser.add_argument('-dataset', type=str, default='cub200',
                        choices=['mini_imagenet', 'cub200', 'cifar100','classroom'])
    parser.add_argument('-dataroot', type=str, default=DATA_DIR)
    parser.add_argument('-train_mode', type=str, default='resnet_a1')
    ...
    parser.add_argument("-size_crops", type=int, default=[224, 96], nargs="+",
                        help="resolution of inputs")#裁剪后的尺寸
